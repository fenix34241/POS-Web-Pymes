...
export const refundApi = {
    getAll: () => request<Refund[]>('/refunds'),

    getById: (id: string) => request<Refund>(`/refunds/${id}`),
    ...
    approve: (id: string, userId: string) =>
        request<{ success: boolean }>(`/refunds/${id}/approve`, {
            method: 'PUT',
            body: JSON.stringify({ userId }),
        }),

    reject: (id: string) =>
        request<{ success: boolean }>(`/refunds/${id}/reject`, {
            method: 'PUT',
        }),
};
